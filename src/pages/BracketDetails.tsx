    ...
    <div style={{
      ...
      <div style={{ minWidth: '1000px', maxWidth: '1400px', margin: '0 auto' }}>
        <header style={{ marginBottom: '4rem' }}>
          <Link to={bracket ? `/tournament/${bracket.categoryId}` : '/'} style={{ display: 'flex', alignItems: 'center', gap: '5px', color: 'rgba(255,255,255,0.5)', textDecoration: 'none', marginBottom: '1rem' }}>
