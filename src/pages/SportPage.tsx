...
const SportPage: React.FC = () => {
  ...
  if (!sport) {
    return (
      <div style={{ padding: isMobile ? '90px 1rem' : '120px 2rem', color: 'white', textAlign: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
          ...
          <section className="glass-card" style={{
            ...
            <div style={{ position: 'absolute', top: '-10px', right: '-10px', opacity: 0.1 }}>
              <Info size={isMobile ? 80 : 120} color={sport.color} />
            </div>
          ...
          <section className="glass-card" style={{
            ...
            <div style={{ position: 'absolute', bottom: '-10px', right: '-10px', opacity: 0.1 }}>
              <Gavel size={isMobile ? 80 : 120} color={sport.color} />
            </div>
            <h2 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: sport.color, marginBottom: '1.5rem' }}>
          ...
          <section style={{ marginTop: '2rem' }}>
            ...
            {tournaments.length > 0 ? (
                ...
                {tournaments.map(t => (
                  <Link key={t.id} to={`/tournament/${t.id}`} style={{ textDecoration: 'none' }}>
                    <div className="glass-card fadeIn" style={{ 
                      padding: isMobile ? '1.5rem' : '2rem', textAlign: 'left', 
              ...
              <div className="glass-card" style={{ padding: isMobile ? '2rem' : '3rem', textAlign: 'center', opacity: 0.6 }}>
